...
<div class="max-w-md mx-auto p-4 bg-white shadow-md rounded-md">
    ...
    <div>
        <label for="height" class="mb-3 block text-base font-medium text-[#07074D]">Height (cm)</label>
        <input 
            type="number" 
            v-model="height" 
            id="height" 
    ...
    <div>
        <label for="weight"  class="mb-3 block text-base font-medium text-[#07074D]">Weight (kg)</label>
        <input 
            type="number" 
            v-model="weight" 
            id="weight" 
